...
export class App extends Component {
  constructor(props) {
    ...
    componentDidMount() {
          ...
          fetch("http://newsapi.org/v2/everything?q=bitcoin&from=2020-06-25&sortBy=publishedAt&apiKey=9ac4846cc5e84dbaa3ad971e8d91521c", {
            "method": "GET",
            /*"params": {
              "q": "bitcoin",
              "from":"2020-06-25",
              "sortBy":"publishedAt",
              "apiKey": "9ac4846cc5e84dbaa3ad971e8d91521c"
            }*/
          })
    ...
    <div class="row">
        ...
        <img class="img-fluid"
          ...
          <div class="card-body">
            <div class="news-title">
              <h2 class=" title-small"><a href="#">Syria war: Why the battle for Aleppo matters</a>
              </h2>
            </div>
      ...
      <div class="col-md-3">
        <div class="card"> <img class="img-fluid"
            src="https://i.guim.co.uk/img/media/73ec9db7723a38dba49ba7409c57da3a779b9531/690_23_3882_2329/master/3882.jpg?width=620&quality=85&auto=format&fit=max&s=372bc821a8d937e821981014036b2c8f" alt=""/>
          <div class="card-img-overlay"> <span class="badge badge-pill badge-danger">Politics</span>
          </div>
          <div class="card-body">
            <div class="news-title">
              <h2 class=" title-small"><a href="#">Key Republicans sign letter warning against</a>
              </h2>
            </div>
            <p class="card-text"><small class="text-time"><em>3 mins ago</em></small></p>
          </div>
      ...
      <div class="col-md-3">
        <div class="card"> <img class="img-fluid"
            src="https://static01.nyt.com/images/2016/08/09/business/09UP-Medicaid/09UP-Medicaid-superJumbo.jpg?quality=90&auto=webp" alt=""/>
      ...
      <div class="col-md-3">
        <div class="card"> <img class="img-fluid"
            src="https://i.insider.com/5d0d3ef19c51010b2c7dadb5?width=900&format=jpeg&auto=webp" alt=""/>
          <div class="card-img-overlay"> <span class="badge badge-pill badge-danger">News</span> </div>
          <div class="card-body">
            <div class="news-title">
